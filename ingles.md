...
| `get_list_source()`                                 | Returns a list of the package sources.                                                                    |

**Note:** The internal function (`get_base`) is intended for module use and **does not need to be used by the user**.
...
try:
    ...
    print(my_pkgbuild.get_list_source())
