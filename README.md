...
| `get_arch()`                                        | Retorna la arquitectura del paquete (`arch`) como string.                                                       |
...
| `get_list_arch()`                                   | Retorna una lista de las arquitecturas del paquete.                                                             |
...
try:
    ...
    print(mi_pkgbuild.get_list_arch())
